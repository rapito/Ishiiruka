...
SlippiConfigPane::SlippiConfigPane(wxWindow *parent, wxWindowID id)
    : wxPanel(parent, id)
{
	InitializeGUI();
	LoadGUIValues();
...
void SlippiConfigPane::BindEvents()
{
	...
	m_replay_month_folders_checkbox->Bind(wxEVT_CHECKBOX, &SlippiConfigPane::OnReplayMonthFoldersToggle, this);
